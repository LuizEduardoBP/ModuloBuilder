...
import { Copy, Check, RefreshCw, ShieldAlert, ShieldCheck, Clipboard, MapPin } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-white/10 pb-4">
        ...
        <p className="text-gray-400 text-sm mt-1">
          Gere CEPs brasileiros válidos e simule consultas de endereço offline de forma instantânea.
        </p>
      </div>
              ...
              <div className="border border-emerald-500/20 bg-emerald-500/5 rounded-xl p-4 space-y-3 text-sm text-indigo-200">
                ...
                <div className="space-y-1.5 font-mono text-xs">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-bold">{address.logradouro}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Bairro:</span>
                    <span className="text-white font-bold">{address.bairro}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Cidade:</span>
                    <span className="text-white font-bold">{address.localidade} ({address.uf})</span>
                  </div>
                </div>
              </div>
            ) : null}
