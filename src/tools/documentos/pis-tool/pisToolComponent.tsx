    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-white/10 pb-4">
        <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent flex items-center gap-2">
          ...
          Gerador & Validador de PIS/PASEP
        </h2>
        <p className="text-gray-400 text-sm mt-1">
          Crie números de PIS/PASEP válidos para testes integrados de holerites e cadastros governamentais.
        </p>
      </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Cole ou digite o PIS/PASEP para validar..."
                maxLength={14}
          ...
          <div className="pt-2">
            {isValid === null ? (
              <div className="border border-white/5 bg-white/5 rounded-xl p-4 flex items-center gap-3 text-sm text-gray-400">
                ...
                Aguardando a digitação de um PIS/PASEP de 11 dígitos.
              </div>
            ) : isValid ? (
              <div className="border border-emerald-500/20 bg-emerald-500/5 rounded-xl p-4 flex items-center gap-3 text-sm text-emerald-300">
                ...
                <div>
                  <span className="font-bold block">PIS/PASEP Válido!</span>
                  <span className="text-xs text-emerald-400/80">O número atende a todos os critérios e cálculos de dígitos do FGTS.</span>
                </div>
              </div>
            ) : (
              <div className="border border-rose-500/20 bg-rose-500/5 rounded-xl p-4 flex items-center gap-3 text-sm text-rose-300">
                ...
                <div>
                  <span className="font-bold block">PIS/PASEP Inválido!</span>
                  <span className="text-xs text-rose-400/80">O dígito verificador calculado não condiz com o documento fornecido.</span>
                </div>
              </div>
            )}
          </div>
