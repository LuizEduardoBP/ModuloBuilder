    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-white/10 pb-4">
        ...
        <p className="text-gray-400 text-sm mt-1">
          Criação rápida de CNPJs (Cadastro Nacional da Pessoa Jurídica) matematicamente válidos para homologações e testes.
        </p>
      </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Cole ou digite o CNPJ para validar..."
                maxLength={18}
          ...
          <div className="pt-2">
            {isValid === null ? (
              <div className="border border-white/5 bg-white/5 rounded-xl p-4 flex items-center gap-3 text-sm text-gray-400">
                ...
                Aguardando a digitação de um CNPJ de 14 dígitos.
              </div>
            ) : isValid ? (
              <div className="border border-emerald-500/20 bg-emerald-500/5 rounded-xl p-4 flex items-center gap-3 text-sm text-emerald-300">
                ...
                <div>
                  <span className="font-bold block">CNPJ Válido!</span>
                  <span className="text-xs text-emerald-400/80">O CNPJ atende a todos os critérios e algoritmos da Receita Federal.</span>
                </div>
              </div>
            ) : (
              <div className="border border-rose-500/20 bg-rose-500/5 rounded-xl p-4 flex items-center gap-3 text-sm text-rose-300">
                ...
                <div>
                  <span className="font-bold block">CNPJ Inválido!</span>
                  <span className="text-xs text-rose-400/80">Os dígitos verificadores calculados não coincidem com o CNPJ digitado.</span>
                </div>
              </div>
            )}
          </div>
