    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-white/10 pb-4">
        ...
        <p className="text-gray-400 text-sm mt-1">
          Gere CPFs de teste matematicamente válidos e faça validações sintáticas instantâneas offline.
        </p>
      </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Cole ou digite o CPF para validar..."
                maxLength={14}
          ...
          <div className="pt-2">
            {isValid === null ? (
              <div className="border border-white/5 bg-white/5 rounded-xl p-4 flex items-center gap-3 text-sm text-gray-400">
                ...
                Aguardando a digitação de um CPF de 11 dígitos.
              </div>
            ) : isValid ? (
              <div className="border border-emerald-500/20 bg-emerald-500/5 rounded-xl p-4 flex items-center gap-3 text-sm text-emerald-300">
                ...
                <div>
                  <span className="font-bold block">CPF Válido!</span>
                  <span className="text-xs text-emerald-400/80">O CPF inserido atende a todos os critérios matemáticos.</span>
                </div>
              </div>
            ) : (
              <div className="border border-rose-500/20 bg-rose-500/5 rounded-xl p-4 flex items-center gap-3 text-sm text-rose-300">
                ...
                <div>
                  <span className="font-bold block">CPF Inválido!</span>
                  <span className="text-xs text-rose-400/80">Os dígitos verificadores do CPF não coincidem.</span>
                </div>
              </div>
            )}
          </div>
