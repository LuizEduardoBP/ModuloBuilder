...
import { genericUseTool } from './genericUseTool';
import { Copy, Check, RotateCcw, FileText, Binary, RefreshCw } from 'lucide-react';

export const genericToolComponent: React.FC<{ onBack?: () => void }> = () => {
  const {
    inputText,
    outputText,
    copied,
